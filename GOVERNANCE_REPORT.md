...
| --- | --- | --- | --- | --- |
|  <ul><li> [x] </li> | R1 | Løsningen skaber lokal værdi | S? | 0 |
| <ul><li> [x] </li> | R2 | Løsningen skaber potentielt værdi for andre | ? | 1 | 
...
| <ul><li> [x] </li> | F7 |Driftskrav til løsningen er dokumenteret | [Se dokumentationen](https://github.com/OS2display)| 1 |
| <ul><li> [x] </li> | F8 | Løsningen er dokumenteret på teknisk niveau  | [Se dokumentationen](https://github.com/OS2display) | 1 |
